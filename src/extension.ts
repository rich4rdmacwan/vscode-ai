...
export function activate(context: vscode.ExtensionContext) {
	...
	// const disposable = vscode.commands.registerCommand('code-ai.helloWorld', () => {
		// The code you place here will be executed every time your command is executed
		// Display a message box to the user
		// vscode.window.showInformationMessage('Hello World from code-ai!');
	// });

	const disposable = vscode.commands.registerCommand("code-ai.start", () => {
